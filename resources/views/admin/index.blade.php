                                        ...
                                        <table class="table mb-0">
                                            ...
                                            <tbody>
                                                <tr>                                                        
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img src="{{ asset('backend/assets/images/products/01.png') }}" height="40" class="me-3 align-self-center rounded" alt="...">
                                                ...
                                                <tr>                                                        
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img src="{{ asset('backend/assets/images/products/02.png') }}" height="40" class="me-3 align-self-center rounded" alt="...">
                                                            <div class="flex-grow-1 text-truncate"> 
                                                ...
                                                <tr>                                                        
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img src="{{ asset('backend/assets/images/products/04.png') }}" height="40" class="me-3 align-self-center rounded" alt="...">
                                                            <div class="flex-grow-1 text-truncate"> 
                                                ...
                                                <tr>                                                        
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img src="{{ asset('backend/assets/images/products/06.png') }}" height="40" class="me-3 align-self-center rounded" alt="...">
                                                            <div class="flex-grow-1 text-truncate"> 
                                                ...
                                                <tr>                                                        
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img src="{{ asset('backend/assets/images/products/05.png') }}" height="40" class="me-3 align-self-center rounded" alt="...">
                                                            <div class="flex-grow-1 text-truncate"> 
                                        ...
                                        <table class="table mb-0">
                                            <tbody>
                                                <tr class="">                                                        
                                                    <td class="px-0">
                                                        <div class="d-flex align-items-center">
                                                            <img src="{{ asset('backend/assets/images/flags/us_flag.jpg') }}" class="me-2 align-self-center thumb-md rounded-circle" alt="...">
                                                            <div class="flex-grow-1 text-truncate"> 
                                                ...
                                                <tr class="">                                                        
                                                    <td class="px-0">
                                                        <div class="d-flex align-items-center">
                                                            <img src="{{ asset('backend/assets/images/flags/spain_flag.jpg') }}" class="me-2 align-self-center thumb-md rounded-circle" alt="...">
                                                            <div class="flex-grow-1 text-truncate"> 
                                                ...
                                                <tr class="">                                                        
                                                    <td class="px-0">
                                                        <div class="d-flex align-items-center">
                                                            <img src="{{ asset('backend/assets/images/flags/french_flag.jpg') }}" class="me-2 align-self-center thumb-md rounded-circle" alt="...">
                                                            <div class="flex-grow-1 text-truncate"> 
                                                ...
                                                <tr class="">                                                        
                                                    <td class="px-0">
                                                        <div class="d-flex align-items-center">
                                                            <img src="{{ asset('backend/assets/images/flags/germany_flag.jpg') }}" class="me-2 align-self-center thumb-md rounded-circle" alt="...">
                                                            <div class="flex-grow-1 text-truncate"> 
                                                ...
                                                <tr class="">                                                        
                                                    <td class="px-0">
                                                        <div class="d-flex align-items-center">
                                                            <img src="{{ asset('backend/assets/images/flags/baha_flag.jpg') }}" class="me-2 align-self-center thumb-md rounded-circle" alt="...">
                                                            <div class="flex-grow-1 text-truncate"> 
                                        ...
                                        <table class="table mb-0">
                                            <tbody>
                                                <tr class="">                                                        
                                                    <td class="px-0">
                                                        <div class="d-flex align-items-center">
                                                            <img src="{{ asset('backend/assets/images/users/avatar-1.jpg') }}" height="36" class="me-2 align-self-center rounded" alt="...">
                                                            <div class="flex-grow-1 text-truncate"> 
                                                ...
                                                <tr class="">                                                        
                                                    <td class="px-0">
                                                        <div class="d-flex align-items-center">
                                                            <img src="{{ asset('backend/assets/images/users/avatar-2.jpg') }}" height="36" class="me-2 align-self-center rounded" alt="...">
                                                            <div class="flex-grow-1 text-truncate"> 
                                                ...
                                                <tr class="">                                                        
                                                    <td class="px-0">
                                                        <div class="d-flex align-items-center">
                                                            <img src="{{ asset('backend/assets/images/users/avatar-3.jpg') }}" height="36" class="me-2 align-self-center rounded" alt="...">
                                                            <div class="flex-grow-1 text-truncate"> 
                                                ...
                                                <tr class="">                                                        
                                                    <td class="px-0">
                                                        <div class="d-flex align-items-center">
                                                            <img src="{{ asset('backend/assets/images/users/avatar-4.jpg') }}" height="36" class="me-2 align-self-center rounded" alt="...">
                                                            <div class="flex-grow-1 text-truncate"> 
                                                ...
                                                <tr>                                                        
                                                    <td class="px-0">
                                                        <div class="d-flex align-items-center">
                                                            <img src="{{ asset('backend/assets/images/users/avatar-5.jpg') }}" height="36" class="me-2 align-self-center rounded" alt="...">
                                                            <div class="flex-grow-1 text-truncate"> 
